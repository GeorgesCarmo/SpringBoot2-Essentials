package academy.devdojo.springboot2.essentials.integration;
...
import academy.devdojo.springboot2.essentials.util.AnimeCreator;
import academy.devdojo.springboot2.essentials.util.AnimePostRequestBodyCreator;
...
public class AnimeControllerIT {
	...
	void findByName_ReturnsEmptyListOfAnime_WhenAnimeIsNotFound() {
		List<Anime> animes = testRestTemplate.exchange("/animes/find?name=randomName", HttpMethod.GET, null, 
				new ParameterizedTypeReference<List<Anime>>() {}).getBody();
